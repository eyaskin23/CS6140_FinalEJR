...
#of weights initialized randomly (gaussian distribution) and biases are uniformly
# distributed random numbers, with subsequent iterations/epochs
...
class hidden_layers(nn.Module):
    def __init__(self, Input_Size, num_nodes1, num_nodes2):
        ...
        #this portion of the code includes a dropout step, randomly zeroing an indicated portion of the first hidden
        #layer's nodes during training
        self.drop = nn.Dropout(0.2)
        # this step randomly initializes weight values
    ...
    def forward(self, inputs):
       ...
       hl_output1 = self.drop(hl_output1)
